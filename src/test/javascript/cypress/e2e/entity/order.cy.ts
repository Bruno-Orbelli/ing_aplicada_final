...
describe('Order e2e test', () => {
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      cy.get(`[data-cy="clientName"]`).type('Soft convergence seize').should('have.value', 'Soft convergence seize');

      cy.get(`[data-cy="orderedAt"]`).type('2024-06-24T07:50').blur().should('have.value', '2024-06-24T07:50');

      cy.get(`[data-cy="isDelivered"]`).should('not.be.checked');
      cy.get(`[data-cy="isDelivered"]`).click().should('be.checked');

      cy.get(`[data-cy="deliveredAt"]`).type('2024-06-24T15:28').blur().should('have.value', '2024-06-24T15:28');
