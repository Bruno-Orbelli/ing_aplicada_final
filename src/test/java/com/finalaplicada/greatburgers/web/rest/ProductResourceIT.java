...
class ProductResourceIT {
    ...
    void putExistingProduct() throws Exception {
        ...
        updatedProduct.productName(UPDATED_PRODUCT_NAME).description(UPDATED_DESCRIPTION).stock(UPDATED_STOCK).price(UPDATED_PRICE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productName(UPDATED_PRODUCT_NAME).description(UPDATED_DESCRIPTION).stock(UPDATED_STOCK).price(UPDATED_PRICE);
