...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './order-det.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERDET_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERDET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERDET actions', async () => {
      const expectedActions = [
        {
