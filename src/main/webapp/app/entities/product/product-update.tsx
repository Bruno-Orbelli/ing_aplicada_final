  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="finalAplicadaApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Stock" id="product-stock" name="stock" data-cy="stock" type="text" />
