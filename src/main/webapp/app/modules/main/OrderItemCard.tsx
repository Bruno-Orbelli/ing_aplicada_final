  ...
  return (
    <div className="card" id="orderItemCard">
      ...
      <div className="card-body text-center">
        ...
        <div className="row">
          <div className="col">
            <button className="btn btn-success" id="plusButton" onClick={handlePlusButtonClick}>+</button>
          </div>
          <div className="col">
            <p id="counter">{item.selectedCounter}</p>
          </div>
          <div className="col">
            <button className="btn btn-danger" id="minusButton" onClick={handleMinusButtonClick}>-</button>
          </div>
        </div>
      </div>
    </div>
